...
type Inquiry = Database['public']['Tables']['event_inquiries']['Row'];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white border border-midnight/10 shadow-sm p-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left font-sans text-sm">
                ...
                <tbody>
                  {reservations.length > 0 ? (reservations as Reservation[]).map((b) => (
          ...
          <div className="bg-white border border-midnight/10 shadow-sm p-6">
            ...
            <div className="flex flex-col gap-4">
              {inquiries.length > 0 ? (inquiries as Inquiry[]).map((enq) => (
