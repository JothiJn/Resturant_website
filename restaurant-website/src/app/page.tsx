          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="absolute -bottom-10 -right-10 bg-navy p-8 rounded-2xl shadow-2xl text-white hidden md:block z-10">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {[
                ...
                >
                  <Image fill src={img} alt="Social Feed" className="object-cover group-hover:scale-110 transition-transform duration-700" />
        ...
        <section className="w-full flex flex-col lg:flex-row min-h-screen">
          ...
          <div className="w-full lg:w-1/2 relative flex items-center justify-center p-8 bg-orange/5">
             ...
             >
               ...
               >
                  <Image src="https://images.unsplash.com/photo-1528821128474-27f963b062bf?auto=format&fit=crop&q=80&w=200" alt="Freshness" fill className="object-cover rounded-full" />
               </motion.div>
             </motion.div>
          </div>
        </section>
